...
public class Constants
{
	...
	public static final String REPORT_EMAIL = "ahmedbodi@crypto-expert.com";
	public static final String REPORT_SUBJECT_ISSUE = CoinDefinition.DONATION_ADDRESS + "Reported issue";
	public static final String REPORT_SUBJECT_CRASH = CoinDefinition.DONATION_ADDRESS + "Crash report";

	public static final String LICENSE_URL = "http://www.gnu.org/licenses/gpl-3.0.txt";
	public static final String SOURCE_URL = "https://github.com/ahmedbodi";
	public static final String BINARY_URL = "http://github.com/ahmedbodi";
	...
	public static final String PREFS_DEFAULT_BTC_PRECISION = "8";
